...
"@
    ...
    if($nt_struct.OptionalHeader.Magic -ne [PE.MagicType]::IMAGE_NT_OPTIONAL_HDR32_MAGIC)
    {
        Write-Verbose "This is not x86 pe";[System.Runtime.InteropServices.Marshal]::FreeHGlobal($pe_buf);return
    }
